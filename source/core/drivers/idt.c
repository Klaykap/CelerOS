...
void set_idt(void) {
    ...
    set_idt_entry(0, isr_address);
    set_idt_entry(1, isr_address);
    set_idt_entry(2, isr_address);
    set_idt_entry(3, isr_address);
    set_idt_entry(4, isr_address);
    set_idt_entry(5, isr_address);
    set_idt_entry(6, isr_address);
    set_idt_entry(7, isr_address);
    set_idt_entry(8, isr8_address);  //double fault
    set_idt_entry(9, isr_address);
    set_idt_entry(10, isr_address);
    set_idt_entry(11, isr_address);
    set_idt_entry(12, isr_address);
    set_idt_entry(13, isr_address);
    set_idt_entry(14, isr_address);
    set_idt_entry(15, isr_address);
    set_idt_entry(16, isr_address);
    set_idt_entry(17, isr_address);
    set_idt_entry(18, isr_address);
